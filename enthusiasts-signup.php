...
$config["dbuser"] = "ora_wanglx01";		// change "cwl" to your own CWL
$config["dbpassword"] = "a88723788";	// change to 'a' + your student number
...
<html lang="en-US">
    ...
    <body class="wrapper">
        ...
        <section class="enthusiasts-signup form">
            <form action="enthusiasts-signup.php" method="POST">
